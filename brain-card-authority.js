/* Brain card authority 3.5.99 — collega il nome visualizzato alla scheda PLAYERS */
(function(){
'use strict';
const VERSION='3.5.99',ROLES=['P','D','C','A'];
...
function boot(){sync();setInterval(sync,250);const old=window.renderBrain;if(typeof old==='function'&&!old.__brainCardAuthority399){const wrapped=function(){const out=old.apply(this,arguments);setTimeout(sync,0);return out};wrapped.__brainCardAuthority399=true;window.renderBrain=wrapped}}
