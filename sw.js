const CACHE = "asta-fantacalcio-v166";
const ASSETS = ["./","./index.html","./app.js","./campetti.js","./ui-fixes.js","./oracolo.js","./brain-picker-fix.js","./brain-engine.js","./brain-oracolo-policy.js","./brain-bet-fix.js","./players.js","./listone-version.json","./manifest.json","./icon.svg","./assets/campetto.JPG"];
...
self.addEventListener("fetch", event => {
 ...
 if(request.mode==="navigate"&&sameOrigin){
  event.respondWith(fetch(request,{cache:"no-store"}).then(async response=>{
   ...
   if(!injected.includes("ui-fixes.js"))injected=injected.replace(/<\/body>/i,'<script src="./ui-fixes.js?v=3.5.92"></script>\n</body>');
   if(!injected.includes("brain-engine.js"))injected=injected.replace(/<\/body>/i,'<script src="./brain-engine.js?v=3.5.96"></script>\n</body>');
   if(!injected.includes("brain-bet-fix.js"))injected=injected.replace(/<\/body>/i,'<script src="./brain-bet-fix.js?v=3.5.97"></script>\n</body>');
