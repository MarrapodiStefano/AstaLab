const CACHE = "asta-fantacalcio-v171";
const ASSETS = ["./","./index.html","./app.js","./campetti.js","./ui-fixes.js","./oracolo.js","./brain-picker-fix.js","./brain-engine.js","./brain-card-authority.js","./brain-oracolo-policy.js","./brain-final-fix.js","./players.js","./listone-version.json","./manifest.json","./icon.svg","./assets/campetto.JPG"];
...
self.addEventListener("fetch", event => {
 ...
 if(request.mode==="navigate"&&sameOrigin){
  event.respondWith(fetch(request,{cache:"no-store"}).then(async response=>{
   ...
   if(!injected.includes("ui-fixes.js"))injected=injected.replace(/<\/body>/i,'<script src="./ui-fixes.js?v=3.5.99"></script>\n</body>');
   ...
   if(!injected.includes("brain-final-fix.js"))injected=injected.replace(/<\/body>/i,'<script src="./brain-final-fix.js?v=3.5.101"></script>\n</body>');
  ...
  }).catch(()=>caches.match(request).then(c=>c||caches.match("./index.html"))));return;
 }
