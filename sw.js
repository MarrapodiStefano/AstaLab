const CACHE = "asta-fantacalcio-v139";

const ASSETS = ["./","./index.html","./app.js","./campetti.js","./ui-fixes.js","./oracolo.js","./brain-picker-fix.js","./brain-target-price-fix.js","./players.js","./listone-version.json","./manifest.json","./icon.svg","./assets/campetto.JPG"];
    ...
    if(request.mode==="navigate" && sameOrigin){
        event.respondWith(
            fetch(request,{cache:"no-store"}).then(async response=>{
                ...
                if(!injected.includes("brain-target-price-fix.js")) injected=injected.replace(/<\/body>/i,'<script src="./brain-target-price-fix.js?v=3.5.71" data-brain-target-price-371></script>\n</body>');
